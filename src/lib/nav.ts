...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/presupuestos", label: "Presupuestos", icon: FileText, pendiente: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/permutas", label: "Permutas", icon: Repeat2, pendiente: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/documentos", label: "Documentos", icon: FileSignature, pendiente: true },
      { href: "/catalogos", label: "Catálogos PDF", icon: FileBox, pendiente: true },
