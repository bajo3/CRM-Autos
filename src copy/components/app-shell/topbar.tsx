      ...
      <Modal open={openAlerts} onClose={() => setOpenAlerts(false)} title="Notificaciones">
        <div className="space-y-3">
          ...
          <div className="rounded-2xl border border-slate-200 p-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-xs text-slate-500">Autos cargados como “Pendiente” (draft).</div>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="rounded-2xl border border-slate-200 p-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                <div className="font-medium text-slate-900">Leads vencidos</div>
                <div className="text-xs text-slate-500">Seguimientos con fecha pasada.</div>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="secondary">{alerts?.overdueLeads ?? 0}</Badge>
          ...
          <div className="rounded-2xl border border-slate-200 p-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-xs text-slate-500">Tareas abiertas con vencimiento pasado.</div>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="secondary">{alerts?.overdueTasks ?? 0}</Badge>
